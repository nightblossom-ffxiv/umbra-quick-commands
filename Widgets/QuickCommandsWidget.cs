...
) : StandardToolbarWidget(info, guid, configValues)
{
    ...
    protected override IEnumerable<IWidgetConfigVariable> GetConfigVariables()
    {
        ...
        for (int i = 1; i <= SlotCount; i++)
        {
            ...
            // Step 1: pick the icon FAMILY here. Then fill in only the matching picker below.
            vars.Add(new SelectWidgetConfigVariable(
                $"Slot{i}_IconType",
                I18N("Icon type"),
                I18N("STEP 1: pick which kind of icon to show. Then fill in only the matching picker below — the other three are ignored. Choose 'None' for no icon."),
                IconTypeNone,
                IconTypeOptions,
                false
            ) { Category = cat });
            ...
            vars.Add(new IconIdWidgetConfigVariable(
                $"Slot{i}_IconGame",
                I18N("Icon — Game id"),
                I18N("Used when Icon type = Game icon."),
                0u
            ) { Category = cat });
            ...
            vars.Add(new FaIconWidgetConfigVariable(
                ...
                I18N("Used when Icon type = FontAwesome."),
            ...
            vars.Add(new GameGlyphWidgetConfigVariable(
                ...
                I18N("Used when Icon type = Game glyph."),
                default(SeIconChar)
            ) { Category = cat });
            ...
            vars.Add(new BitmapIconWidgetConfigVariable(
                ...
                I18N("Used when Icon type = Bitmap font."),
